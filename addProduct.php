...
<body>
    ...
    <div class=" container-fluid " style="margin: 0; padding: 0;">
        ...
        <div class="Sproduct " style="background-color:#bde6fae4 ;padding-bottom:20px;">
            <?php 
            ...
            ?>
                ...
                <div class="" style="min-height:100vh;">
                    <div class="d-lg-flex justify-content-lg-center  " style="margin: 0; padding-top:3em;padding-bottom:3em;">
                    <div class="row offset-lg-1 col-lg-11 col-md-12 col-12 product-dis d-md-flex  py-4 wrapper2 mt-4" style="padding: 0;margin: 0;justify-content:left;">
                        <div class="col-12 text-center">
                            <h2 class="h2 text-secondary fw-bold">Add New Product</h2><br><br>
                        </div>
<div class="row">
                        ...
                        <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="offset-lg-3 col-12 col-lg-6">
                                            <div class="row justify-content-center">
                                                <div class="col-6 border border-primary rounded">
                                                    <img src="resource/addproductimg.jpeg" class="img-fluid" style="width: 250px;" id="i0"/>
                                                </div>
                                        ...
                                        <div class="offset-lg-3 col-12 col-lg-6 d-grid mt-3">
                                            ...
                                            <label for="imageuploader" class="col-12 btn btn-primary" onclick="changeProductImage();">Upload Image</label><br>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                    ...
                    <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6  border-success">
                                    <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <select class="col-12 form-select" id="clr">
                                                        ...
                                                        ?>
                                                            ...
                                                            <option value="<?php echo $clr_data["color_id"]; ?>"><?php echo $clr_data["clr_name"]; ?></option>
                               ...
                               <div class="col-12 row offset-lg-3">
                                <div class=" col-12 col-lg-3 d-grid mt-3 mb-3">
                                    <button class="btn btn-success" onclick="addProduct();">Save Product</button>
                                </div>
                                <div class="col-12 col-lg-3 d-grid mt-3 mb-3">
                                    <button class="btn btn-danger" ><a href='adminPanel.php' style='text-decoration:none;color:white;'>Admin Panel</a></button>
                                </div>
                                                    </div>
                            </div>
                        </div>
