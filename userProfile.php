...
<head>
    ...
    <title>YanKee | User Profile</title>
...
<body>
    ...
    <div class="bodytop container-fluid bodytop " style="overflow-x: hidden;background-color:#bde6fae4 ;">
        <div class="row Sproduct " style="padding-bottom:20;">
            ...
            if (isset($_SESSION["u"])) {
                ...
                user_has_address.city_id=city.city_id INNER JOIN `district` ON 
            ...
            ?>
                ...
                <div class="" style="min-height:100vh;">
                    <div class="d-lg-flex justify-content-lg-center col-12 profile-border" >

                        <div class="row col-sm-12 offset-lg-2 offset-sm-0 col-lg-10  col-md-12  product-dis d-md-flex justify-content-md-center py-4 wrapper2 mt-3" style="padding: 0;margin: 0;">
                            <div class="row g-2">

                                <div class=" border-end " >
                                    <div class="d-flex flex-column align-items-center  offset-lg-4 col-4 text-center p-3 py-5" style="padding:0;">

                                        <?php

                                        if (empty($image_details["path"])) {
                                        ?>
                                            <img src="resource/new_user.jpeg" class="rounded mt-1" style="width: 120px;" />
                                        <?php
                                        } else {
                                        ?>
                                            <img src="<?php echo $image_details["path"]; ?>" class="rounded mt-1" style="width: 150px;" />
                                        <?php
                                        }
                                        ...
                                        <span class="fw-bold mt-3"><?php echo $details["fname"] . " " . $details["lname"]; ?></span>
