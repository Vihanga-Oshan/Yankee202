...
<body style="overflow-x: hidden;">
    ...
    <div class="product-container " style="background-color:#bde6fae4; margin-top:13em;"></div>
        ...
        <div class="" style="min-height: 20vh;">
            <div class="d-lg-flex justify-content-lg-center " style="margin: 0; padding: 0;">
                <div class="row offset-lg-1 col-lg-11 col-md-12 col-12 product-dis d-md-flex justify-content-md-center py-4" style="padding: 0;margin: 0;">
                    <div class="d-flex justify-content-start px-5 align-items-center" style="font-weight:800;">
                        <h4>Order History</h4>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-12 ">
                        ...
                        <div class="bodere" style="overflow-y: scroll; overflow-x: hidden; height: 70vh;">
                            <?php
                            $rs = Database::search("SELECT * FROM `order` WHERE `order`.user_email='" . $_SESSION['u']['email'] . "' ;");
                            ...
                            if ($num >= "1") {
                                for ($x = 0; $x < $num; $x++) {
                                    ...
                                    $ps = Database::search("SELECT * FROM `order_product` WHERE `order_product`.order_id='" . $d['id'] . "' ;");
                                    ...
                                    $ns = Database::search("SELECT * FROM `product` WHERE `product`.id='" . $d2['product_id'] . "' ;");
                                    $d3 = $ns->fetch_assoc();
                            ...
                            ?>
                                    ...
                                    <div class="col-2"></div>
                                        ...
                                        <div class="col-2 pt-2" >
                                            <p><?php echo ($d2['quantity']); ?></p>
                                        </div>
                                        <div class="col-2 pt-2" >
                                            <p><?php echo ($d3['title']); ?></p>
                                        </div>
